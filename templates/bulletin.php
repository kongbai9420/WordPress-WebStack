...
<div id="bulletin_box" class="panel">
    <div class="d-flex text-muted bulletin-wrap">
		<div class="bulletin-icon"><i class="fa fa-volume-up"></i></div>
        ...
        <a title="关闭" href="javascript:;" rel="external nofollow" onClick="$('#bulletin_box').slideUp('slow');" class="bulletin-close"><i class="fa fa-remove"></i></a>
    </div>
</div>
<script> 
