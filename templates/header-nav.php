...
<div class="sidebar-menu toggle-others fixed">
            <div class="sidebar-menu-inner">
                <header class="logo-env">
                    <!-- logo -->
                    <div class="logo">
                        <a href="<?php bloginfo('url') ?>" class="logo-expanded brand-link">
                            <span class="brand-mark">
                                <img src="<?php echo io_get_option('logo_small') ?>" height="40" alt="<?php bloginfo('name') ?>" />
                            </span>
                            <span class="brand-text-group">
                                <strong class="brand-title"><?php bloginfo('name') ?></strong>
                                <span class="brand-subtitle"><?php bloginfo('description') ?></span>
                            </span>
                        </a>
                        <a href="<?php bloginfo('url') ?>" class="logo-collapsed brand-link-collapsed">
                            <span class="brand-mark">
                                <img src="<?php echo io_get_option('logo_small') ?>" height="40" alt="<?php bloginfo('name') ?>">
                            </span>
                        </a>
